...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    MO(LAYER1),          KC_UP,               MO(LAYER1),          KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
  KC_GRAVE,  KC_LCTL, KC_LALT, KC_LCMD, KC_SPC,  KC_DEL,  KC_LEFT,             KC_DOWN,             KC_RIGHT,            KC_ENT,  KC_BSPC, KC_HOME, KC_END,  KC_PGUP, KC_PGDOWN
  ),
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, ________,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, ________,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, ________,
  ),
